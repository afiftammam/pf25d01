...
public class Cell implements Serializable {
    ...
    public Cell(int row, int col) { this.row = row; this.col = col; newGame(); }
    public void newGame() { content = Seed.NO_SEED; }
    ...
    public void paint(Graphics2D g2d) {
        ...
        g2d.setColor(Theme.bgPanel); // Perbaikan
        ...
        if (content == Seed.CROSS) {
            g2d.setColor(Theme.CROSS_COLOR); // Perbaikan
            ...
            g2d.setColor(Theme.NOUGHT_COLOR); // Perbaikan
